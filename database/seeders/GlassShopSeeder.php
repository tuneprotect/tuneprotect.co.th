...
class GlassShopSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $arr[] = [
            ...
            'th' => ['title' => 'โรงพยาบาลกรุงเทพ', 'address' => '22 ซอยศูนย์วิจัย 7 ถ.เพชรบุรีตัดใหม่ ห้วยขวาง กรุงเทพมหานคร 10320'],
...
038-538-511-3', 'cat_id' => '92',
        ...
        foreach ($arr as $v) {
            $partner = Partner::create([
                'type_id' => ProjectEnum::WEB_CONTENT_GLASS_SHOP,
                'cat_id' => $v['cat_id'],
                'website' => $v['website'],
                'location' => $v['location'],
                'tel' => $v['tel'],
