...
class TGISMController  extends ProductController
{
    protected $controller = 'tgism';
    public function index($link = null, $selected = null)
    {
        ...
        $this->template->setFootJS(mix("/js/frontend/tgism.js"));
        return $this->genView('frontend.page.tgism_validation');
     ...
     public function Validation(Request $request)
     {
         ...
         else
         {
             ...
             return parent::index('coronavirus-covid-19-insurances','TGCVLP',$memberId);
