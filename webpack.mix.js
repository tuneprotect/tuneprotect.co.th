...
mix.react('resources/backstage_source/index.js', 'public/js/backstage')
    ...
    .js('resources/js/glass_shop.js', 'public/js/frontend')
    ...
    .js('resources/js/product/ontask.js', 'public/js/frontend/product/')
    ...
    .js('resources/js/product/taipoct22aa.js', 'public/js/frontend/product/')
    ...
    .js('resources/js/product/cigc.js', 'public/js/frontend/product/')
    ...
    .js('resources/js/product/ontato.js', 'public/js/frontend/product/')
    ...
    .js('resources/js/product/taismc.js', 'public/js/frontend/product/')
    .js('resources/js/product/oncshc.js', 'public/js/frontend/product/')
    .js('resources/js/product/oncshcaa.js', 'public/js/frontend/product/')
    .js('resources/js/product/oncshcsc.js', 'public/js/frontend/product/')
    .js('resources/js/product/oncshcgv.js', 'public/js/frontend/product/')
    .js('resources/js/product/oncsh.js', 'public/js/frontend/product/')
    ...
    .js('resources/js/product/onb2btad.js', 'public/js/frontend/product/')
    .js('resources/js/product/pumppa.js', 'public/js/frontend/product/')
    .js('resources/js/product/taipcrn.js', 'public/js/frontend/product/')
