...
document.addEventListener("DOMContentLoaded", function () {
  if (Object(_helper__WEBPACK_IMPORTED_MODULE_0__["$$"])('.claimCollapse')) {
    Object(_helper__WEBPACK_IMPORTED_MODULE_0__["$$"])('.claimCollapse').forEach(function ($el) {
      var $parent = $el.closest('li');
      $el.addEventListener('click', function (e) {
        e.preventDefault();
        Array.from(Object(_helper__WEBPACK_IMPORTED_MODULE_0__["$$"])('.claim-menu li')).forEach(function (el) {
          el.classList.remove('on');
        });
        Array.from(Object(_helper__WEBPACK_IMPORTED_MODULE_0__["$$"])('.claimCollapsePanel')).forEach(function (el) {
          el.classList.remove('on');
        });
        Object(_helper__WEBPACK_IMPORTED_MODULE_0__["$$"])(".claimCollapsePanel").forEach(function ($section) {
          if ($el.getAttribute('data-index') === $section.getAttribute('data-index')) {
            $parent.classList.toggle('on');
            $section.classList.toggle('on');
            var node = $section.cloneNode(true);
            document.getElementById('claim_result').innerHTML = "";
            Object(_helper__WEBPACK_IMPORTED_MODULE_0__["$"])('#claim_result').appendChild(node);
          }
        });
      });
    });
  ...
  if (Object(_helper__WEBPACK_IMPORTED_MODULE_0__["$"])('#claim_menu li:first-child h2')) {
    Object(_helper__WEBPACK_IMPORTED_MODULE_0__["$"])('#claim_menu li:first-child h2').click();
  }
});
...
/***/ 7:
/*!********************************************!*\
  !*** multi ./resources/js/claim_detail.js ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\Pattarapong\Tuneprotect\tuneprotect.co.th\resources\js\claim_detail.js */"./resources/js/claim_detail.js");
