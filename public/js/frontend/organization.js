...
var calculateAge = function calculateAge(date) {
  ...
  var age = Object(date_fns__WEBPACK_IMPORTED_MODULE_1__["parseISO"])(date); // console.log('age :' + age);

  var year = Object(date_fns__WEBPACK_IMPORTED_MODULE_1__["differenceInYears"])(now, age); // console.log('year :' + year);
...
document.addEventListener("DOMContentLoaded", function () {
  var office = Object(_helper__WEBPACK_IMPORTED_MODULE_0__["$$"])(".officer");
  office.forEach(function ($el) {
    $el.addEventListener('click', function (e) {
      e.preventDefault();
      Object(_helper__WEBPACK_IMPORTED_MODULE_0__["$"])('.page-overlay').style.display = 'flex';
      Object(_helper__WEBPACK_IMPORTED_MODULE_0__["$"])('#sp_image').src = $el.getAttribute('data-img');
      Object(_helper__WEBPACK_IMPORTED_MODULE_0__["$"])('#span_name').innerHTML = $el.getAttribute('data-name');
      Object(_helper__WEBPACK_IMPORTED_MODULE_0__["$"])('#span_position').innerHTML = $el.getAttribute('data-position');
      Object(_helper__WEBPACK_IMPORTED_MODULE_0__["$"])('#span_department').innerHTML = $el.getAttribute('data-department');
    }, true);
  });
  var close = Object(_helper__WEBPACK_IMPORTED_MODULE_0__["$"])(".page-overlay .close");
  close.addEventListener('click', function (e) {
    e.preventDefault();
    Object(_helper__WEBPACK_IMPORTED_MODULE_0__["$"])('.page-overlay').style.display = 'none';
  }, true);
});
...
module.exports = __webpack_require__(/*! C:\Pattarapong\Tuneprotect\tuneprotect.co.th\resources\js\organization.js */"./resources/js/organization.js");
