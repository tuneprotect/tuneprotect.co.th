...
var calculateAge = function calculateAge(date) {
  ...
  var month = Object(date_fns__WEBPACK_IMPORTED_MODULE_1__["differenceInMonths"])(now, age);
  ...
  var day = Object(date_fns__WEBPACK_IMPORTED_MODULE_1__["differenceInDays"])(now, age);
...
document.addEventListener("DOMContentLoaded", function () {
  var $btnMore = Object(_helper__WEBPACK_IMPORTED_MODULE_0__["$"])('#btn-more');
  $btnMore.addEventListener("click", function (e) {
    e.preventDefault();
    Object(_helper__WEBPACK_IMPORTED_MODULE_0__["$$"])('.partner_table tbody tr').forEach(function (row) {
      row.style.display = 'table-row';
    });
    Object(_helper__WEBPACK_IMPORTED_MODULE_0__["$"])('.partner_table tfoot').style.display = 'none';
  });
  var locale = Object(_helper__WEBPACK_IMPORTED_MODULE_0__["$"])('html').getAttribute('lang');
  var orderBy = {
    field: "title",
    direction: "asc"
  };

  var descendingComparator = function descendingComparator(a, b, field) {
    var recA, recB;
  ...
  var getComparator = function getComparator(orderBy) {
    return orderBy.direction === 'desc' ? function (a, b) {
      return descendingComparator(a, b, orderBy.field);
    } : function (a, b) {
      return -descendingComparator(a, b, orderBy.field);
    };
  };

  var stableSort = function stableSort(dataList, comparator) {
    if (dataList.length === 0) {
      return dataList;
    }

    var stabilizedThis = dataList.map(function (el, index) {
      return [el, index];
    });
  ...
  var data = JSON.parse(Object(_helper__WEBPACK_IMPORTED_MODULE_0__["$"])('#div_result').innerHTML);
  Object(_helper__WEBPACK_IMPORTED_MODULE_0__["$"])('#div_result').remove();

  var handleFilterData = function handleFilterData() {
    if (Object.keys(filterParam).every(function (k) {
      return filterParam[k] === "";
    })) {
      return stableSort(data, getComparator(orderBy));
    }

    return stableSort(data.filter(function (rowData) {
      ...
      if (filterParam.title !== "" && (rowData === null || rowData === void 0 ? void 0 : rowData.locales[locale].title.toLowerCase().indexOf(filterParam.title.toLowerCase())) === -1) {
        return false;
      }
  ...
  var genResult = function genResult(filteredData) {
    var $tbody = Object(_helper__WEBPACK_IMPORTED_MODULE_0__["$"])('.partner_table tbody');
    $tbody.innerHTML = '';
    filteredData.map(function (v) {
      var $tr = document.createElement('tr');
      var arrTel = v.tel.split(',').map(function (v1) {
        return "<a class=\"btn btn-outline btn-thin\" href=\"tel:".concat(v1, "\">").concat(v1, "</a>");
      });
      $tr.innerHTML = "<td><strong>".concat(v.locales[locale].title, "</strong>\n                            <p>").concat(v.locales[locale].address, "</p></td>\n\n                <td>").concat(arrTel.join(''), "</td>\n                <td>\n                    <div class=\"btn-wrapper\">\n                    ").concat(v.website ? "<a class=\"btn btn-outline btn-thin\" target=\"_blank\" href=\"".concat(v.website, "\">").concat(Object(_helper__WEBPACK_IMPORTED_MODULE_0__["$"])(".partner_table").getAttribute('data-website'), "</a>") : '', "\n                    ").concat(v.location ? "<a class=\"btn btn-outline btn-thin\" target=\"_blank\" href=\"".concat(v.location, "\">").concat(Object(_helper__WEBPACK_IMPORTED_MODULE_0__["$"])(".partner_table").getAttribute('data-location'), "</a>") : '', "\n                    </div>\n                </td>");
      $tbody.appendChild($tr);
    });
  };

  var showResult = function showResult() {
    var filteredData = handleFilterData();
    genResult(filteredData);
  };

  Object(_helper__WEBPACK_IMPORTED_MODULE_0__["$$"])('#ctrl_province,#ctrl_category,#ctrl_language').forEach(function ($el) {
    $el.addEventListener('change', function (e) {
      filterParam = _objectSpread(_objectSpread({}, filterParam), {}, _defineProperty({}, e.target.name, e.target.value));
      showResult();
    });
  });
  Object(_helper__WEBPACK_IMPORTED_MODULE_0__["$$"])('#ctrl_name').forEach(function ($el) {
...
/***/ 4:
/*!****************************************!*\
  !*** multi ./resources/js/hospital.js ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\Pattarapong\Tuneprotect\tuneprotect.co.th\resources\js\hospital.js */"./resources/js/hospital.js");
