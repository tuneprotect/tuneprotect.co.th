    ...
    RS.prototype.setValues = function (start, end) {
        ...
        if (this.conf.range) {
            if (this.conf.tooltip) {
                ...
                if (this.conf.tooltipFormat) {
                    this.tipL.innerHTML = this.conf.tooltipFormat(this.conf.values[this.values.start]);
                    this.tipR.innerHTML = this.conf.tooltipFormat(this.conf.values[this.values.end]);
                } else {
