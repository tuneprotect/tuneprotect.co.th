                    ...
                    case 3:
                        ...
                        <div class="two-col">
                            ...
                            ${$('#controller').value === 'product' && promotionCodeStatus
                                ? `<div class="controls-wrapper full no-lable"><span>${$('#lblfdPromotionCode').innerText} : </span><strong>${$('#fdPromotionCode').value} ${ promotion_data.result.status ? `<span id="promotion_code_alert" style="color: #008b06;">${locale === 'th' ? '('+ promotion_data.result.message +')'`
                                ${ promotion_data.result.codeAvailable < i+1 
                                    ...
                                    : '('+ promotion_data.result.message_th +')'}</span>` 
