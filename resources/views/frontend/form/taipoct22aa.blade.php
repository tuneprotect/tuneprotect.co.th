...
<section id="step1" class="wrapper">
    <form method="post" action="" class="insurance-form">
        ...
        @endif
        <input type="hidden" id="ctrl_massage1" value="@lang("product.biglife.message1")"/>
...
@include('frontend.component.form-taipoct-coverage-table',['package_detail' => $package_detail,'selected' =>$selected ])
