...
@section('page')    
    ...
    @if(isset($portalKey))
        ...
        @if(isset($portalKey) && $portalKey == '00DM004D00')
			<script>
				console.log("https://invle.co/aff_lsr?offer_id=103074&adv_sub={{$refCode}}&adv_sub2={{$package}}&adv_ sub3={}&adv_sub4={}&adv_sub5={}&adv_sub6={}&adv_sub7={}&amount={{$payAmount}}&currency=THB&transaction_id={{$transaction_id}}");
