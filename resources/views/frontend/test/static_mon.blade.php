...
@section('page')
    ...
    <main>
        <article class="wrapper">
            ...
            <h1>My Health</h1>
            <div>
                <div class="my-health-title">
                    <img alt="" src="/storage/profile_vrt_raw_bytes_1587515361_10542.jpg"/>
                    <span>
    ไร้กังวลทุกที่ทุกเวลา เพราะเจ็บป่วยเมื่อไหร่ ก็สามารถขอรับคำปรึกษากับแพทย์ผู้เชี่ยวชาญออนไลน์ได้ เพียงเป็นลูกค้า Tune Protect  (เงื่อนไขเป็นไปตามที่บริษัทฯ)
                ...
                <section class="my-health-step">
                    ...
                    <div class="step-wrapper">
                        <div id="step">
                            <div class="item">
                                <img alt="" src="/storage/profile_vrt_raw_bytes_1587515361_10542.jpg" style="width: 50px;height: 50px">
                                <strong>click</strong>
                                <p>
                                    บริการปรึกษาแพทย์
                                </p>
