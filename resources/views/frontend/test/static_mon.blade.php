            ...
            @endif
                ...
                <div class="wrapper">
                    <div>
                        ...
                        <p>เพราะโรคร้ายแรงมีมากกว่าที่คิด! ประกันโรคร้ายแรงจาก Tune Protect พร้อมดูแลคุ้มครองโรคร้ายทุกระยะ และเลือกความคุ้มครองโรคร้ายเพิ่มเติมได้ตามต้องการ สมัครได้ตั้งแต่อายุ 18-60 ปี ต่ออายุได้ถึง 65 ปี ลดหย่อนภาษีได้ พร้อมบริการความเห็นที่สองทางการแพทย์และบริการปรึกษาแพทย์ออนไลน์</p>
                            ...
                            <div class="highlight-ci-wrapper" style="margin-bottom: 20px">
                                <div id="step">
                                    ...
                                    <div class="item"><span class="material-icons md-dark">health_and_safety</span>
                                        ...
                                        <p style="font-size: .8rem">คุ้มครอง<br />
                                            5 กลุ่มโรคร้ายแรง</p>
                                    </div>
                                    ...
                                    <div class="item"><span class="material-icons md-dark">savings</span>
                                        ...
                                        <p style="font-size: .8rem">เบี้ยเริ่มต้น<br />
                                            เพียงไม่ถึง 2 บาทต่อวัน</p>
                                    </div>
                                    ...
                                    <div class="item"><span class="material-icons md-dark">trending_down</span>
                                        ...
                                        <p style="font-size: .8rem">เบี้ยประกันนำไป<br />
                                            ลดหย่อนภาษีได้*</p>
                                    </div>

                                    <div class="item"><span class="material-icons md-dark">medical_services</span>

                                        <p style="font-size: .8rem">มีบริการความเห็นที่สองทางการแพทย์ และปรึกษาแพทย์ออนไลน์</p>
                                    </div>
                                </div>
                            </div>
