                                                ...
                                                @if($v1->productPackage)
                                                    <ul>
                                                        @foreach ($v1->productPackage as $v2)
                                                            <li>
                                                            @if($v2->code === 'ONCSHC' || $v2->code === 'ONCANCER' || $v2->code === 'CI'|| $v2->code === 'DIABETES' || $v2->code === 'ONPACA' || $v2->code === 'ONPAKD' || $v2->code === 'ONPASN' || $v2->code === 'TAISM' || $v2->code === 'TAIPOCT22' || $v2->code === 'ONTADM' || $v2->code === 'ONTAOB' || $v2->code === 'ONFIMP' || $v2->code === 'ONMHS')
                                                                <a data-gtm="main-nav-product-{{$v1->friendly_url}}-{{$v2->code}}"
                                                                    ...
                                                                    <span>{{$v2->locales[$locale]->title}}
                                                                        @if($v2->code === 'ONCANCER')                                                            
                                                                            <img id="imgnew" src="https://www.tuneprotect.co.th/storage/Icon/new2.gif" style="width:25%;margin-bottom: -5px;" />
                                                                        @endif
                                                                    </span>
                                                                </a>
                                                            @endif
                            ...
                            @if(!empty($v->pic_en))
                                @if(isset($selected))
                                    ...
                                    @elseif($selected==='CIGC')
                                        <picture>
                                            <source media="(min-width:768px)" srcset="/storage/Banner/MyFlexiCI/MyFlexiCIGC/Banner_Website_CIGC_EN.webp">
                                            <img src="{{url(!empty($v->pic_mobile_en) ? "/storage/Banner/MyFlexiCI/MyFlexiCIGC/Banner_Website_CIGC_EN.webp" : "/storage/Banner/MyFlexiCI/MyFlexiCIGC/Banner_Website_CIGC_EN.webp" )}}" alt="{{$v->locales[$locale]->title}}">
                                        </picture>
                                    ...
                                    @elseif($selected==='ONCSHC')
                                        <picture>
                                            ...
                                            <img src="{{url(!empty($v->pic_mobile_en) ? url('/storage/Banner/chillsure/banner-chillsure-mb-en.webp') : url('/storage/Banner/chillsure/banner-chillsure-mb-en.webp'))}}" alt="{{$v->locales[$locale]->title}}">
                                        </picture>
                                    @elseif($selected==='ONCSHCAA')
                                        <picture>
                                            ...
                                            <img src="{{url(!empty($v->pic_mobile_en) ? "/storage/Banner/chillsure/banner-chillsure-airasia-mobile-en.webp" : "/storage/Banner/chillsure/banner-chillsure-airasia-mobile-en.webp" )}}" alt="{{$v->locales[$locale]->title}}">
                                        </picture>
                                    ...
                                    @elseif($selected==='TAIPOCT22AA')
                                        <picture class="aa">
                                            <source media="(min-width:768px)" srcset="/storage/Banner/Tune%20iPass/dtacbanner.jpg">
                                            <img src="{{url(!empty($v->pic_mobile_en) ? "/storage/Banner/Tune%20iPass/dtacbanner.jpg" : "/storage/Banner/Tune%20iPass/dtacbanner.jpg" )}}" alt="{{$v->locales[$locale]->title}}">
                                        </picture>      
                                    ...
                                    @else
                                        @if($selected==='ONTAOB')
                                            <picture>
                                                ...
                                                <img src="{{url(!empty($v->pic_mobile_en) ? url('/storage/Banner/iTravel/banner-itravel-mb-en.webp') : url('/storage/Banner/iTravel/banner-itravel-mb-en.webp'))}}" alt="{{$v->locales[$locale]->title}}">
                                            </picture>
                                        @endif
                                        @if($selected !== 'ONTAOB')
                                                <picture>
                        ...
                        @else
                            @if(!empty($v->pic))
                                @if(isset($selected))
                                    ...
                                    @elseif($selected==='CIGC')
                                        <picture>
                                            <source media="(min-width:768px)" srcset="/storage/Banner/MyFlexiCI/MyFlexiCIGC/Banner_Website_CIGC_TH.webp">
                                            <img src="{{url(!empty($v->pic_mobile_en) ? "/storage/Banner/MyFlexiCI/MyFlexiCIGC/Banner_Website_CIGC_TH.webp" : "/storage/Banner/MyFlexiCI/MyFlexiCIGC/Banner_Website_CIGC_TH.webp" )}}" alt="{{$v->locales[$locale]->title}}">
                                        </picture>
                                    @elseif($selected==='ONFIMP')
                                        <picture>
                                    ...
                                    @elseif($selected==='ONCSHC')
                                        <picture>
                                            ...
                                            <img src="{{url(!empty($v->pic_mobile_en) ? url('/storage/Banner/chillsure/banner-chillsure-mb-th.webp') : url('/storage/Banner/chillsure/banner-chillsure-mb-th.webp'))}}" alt="{{$v->locales[$locale]->title}}">
                                        </picture>
                                    @elseif($selected==='ONCSHCAA')
                                        <picture>
                                            <source media="(min-width:768px)" srcset="/storage/Banner/chillsure/banner-chillsure-airasia-desktop-th.webp">
                                            <img src="{{url(!empty($v->pic_mobile_en) ? "/storage/Banner/chillsure/banner-chillsure-airasia-mobile-th.webp" : "/storage/Banner/chillsure/banner-chillsure-airasia-mobile-th.webp" )}}" alt="{{$v->locales[$locale]->title}}">
                                        </picture> 
                                    @elseif($selected==='ONCSHCSC')
                                        <picture>
                                    ...
                                    @else
                                        @if($selected==='ONTAOB')
                                            <picture>
                                                ...
                                                <img src="{{url(!empty($v->pic_mobile_en) ? url('/storage/Banner/iTravel/banner-itravel-mb-th.webp') : url('/storage/Banner/iTravel/banner-itravel-mb-th.webp'))}}" alt="{{$v->locales[$locale]->title}}">
                                            </picture>
                                        @endif
                                        @if($selected !== 'ONTAOB')
                                                <picture>
