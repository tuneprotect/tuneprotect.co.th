                        ...
                        @else
                            @if(!empty($v->pic))
                                @if(isset($selected))
                                    ...
                                    @elseif($selected==='ONMHS')
                                        <picture>
                                            <source media="(min-width:768px)" srcset="{{url(str_replace('TuneFireInsurance-D-EN', 'myHomeSmart_Th_pc', $v->pic_en))}}">
                                            <img src="{{url(!empty($v->pic_mobile_en) ? url(str_replace('TuneFireInsurance-D-EN', 'myHomeSmart_Th_pc', $v->pic_mobile_en)) : url(str_replace('TuneFireInsurance-D-EN', 'myHomeSmart_Th_mobile', $v->pic_en)) )}}"
                                                alt="{{$v->locales[$locale]->title}}">
                                        </picture>
                                        <!--picture>
                                            <source media="(min-width:768px)"
