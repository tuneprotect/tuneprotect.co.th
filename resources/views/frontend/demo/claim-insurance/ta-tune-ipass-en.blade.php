...
@section('page')
    ...
    <main>
        <article class="wrapper">
            ...
            <h1>TUNE I – PASS: TA Inbound For Foreign (VISA 100K USD)
            </h1>

            <div>
                <h2 class="text-primary">Claims Handling Process for TUNE I – PASS: TA Inbound For Foreign (VISA 100K
                    USD)</h2>
                <h2 class="text-primary">Process, Period, and Method of Claims Submission</h2>
                <ul>
                    <li>
                        ...
                        <ul style="padding-left:20px;">
                            ...
                            <li>- Contact the Company in person or by mailing service to Non-Motor Claims Department
                ...
                <p>
                    <strong>The policyholder and/or the insured,</strong> the beneficiary, or the representative
                    thereof, as the case may be, shall notify the Company of the injury or the sickness without delay
                    and submit the evidence and documents stated below to the Company.
                </p>
                <p>
                ...
                <ul>
                    <li>
                        1. Claims form <a
                                href="/storage/claim-insurance/tune-ipass/ta-inbound-for-foreign.pdf"
                ...
                <p>
                    <strong>In case of death, the following supporting documents for consideration of claims <span
                ...
                <ul>
                    ...
                    <li>5. Form of assessment of dismemberment and loss of sight issued by the physician
                    ...
                    <li>8. Daily report on the incident <span style="text-decoration: underline;">(if any)</span>
                        (signed for certification of true copy by the competent police officer)

                    </li>
                    <li>9. Summary of the case and photo of the scene <span
                ...
                <p>
                    <strong>
                        In case of permanent disability, please submit the following supporting documents for the claims
                        consideration <span style="text-decoration: underline;">(original)</span></strong>
                </p>
                ...
                <ul>
                    ...
                    <li>8. Daily report on the incident <span
                                style="text-decoration: underline;">(if any)</span> (signed for certification of true
                    ...
                    <li>10. Copy of the first page of saving account passbook of the insured/the curator/guardian
                    </li>
                    <li>11. Copy of identification card of the curator signed for certification of true copy

                    </li>
                    <li>12. Copy of house registration of the curator signed for certification of true copy</li>
                    <li>13. Certificate or letter of appointment of the curator
                    </li>
                    <li>14. Copy of the first page of saving account passbook of the insured/the curator
                    </li>
                </ul>
                <p>
                    <strong>Flight Cancellation or Postponement
                    </strong>
                </p>
                <ul>
                ...
                <ul>
                    ...
                    <li>4. Copy of receipt of expense for trip curtailment and the boarding pass of Air Asia
                ...
                <ul>
                    <li>1. Document indicating the departure date, delay period, and the cause of delay issued by the
                        airline or the public transportation company
                    </li>
                    <li>2. Other required documents as requested by the Company
                    </li>
                </ul>
                <p>
                    <strong>Travel Expense for the Patient Visitation at the Hospital
                    </strong>
                </p>
                <ul>
                    <li>1. Original receipt for travel, accommodation, and meal expense

                    </li>
                    <li>2. All reports from the physician

                    </li>
                    <li>3. Other required documents as requested by the Company
                ...
                <ul>
                    <li>1. Irregularity report of the airline
                    </li>
                    ...
                    <li>5. Baggage tag or baggage check-in tag of the airline
                ...
                <ul>
                    <li>1. Baggage tag or baggage check-in tag of Air Asia
                    </li>
                    <li>2. Irregularity report of Air Asia or the management of the public transportation company
                    </li>
                </ul>
                <p>
                    <strong>Medical Expense due to Injury or Sickness</strong>
                </p>
                <ul>
                    <li>1. Medical report or medical certificate indicating significant symptom, diagnosis result, and
                        treatment
                ...
                <p>
                    <strong>Emergency Medical Evacuation & Repatriation Expense</strong>
                </p>
                <ul>
                    <li>You may contact Tune Insurance PCL. or Tune Protect Thailand (“TPT”) at +662 078 5656, press 1
                        and press 4.
                    </li>
                </ul>
                <p>
                    <strong>Loss or Damage of Travel Documents</strong>
                </p>
                <ul>
                    <li>1. Copy of passport of the insured and/or travel evidence, as the case may be
                    </li>
                    <li>
                        2. Copy of daily report of the local police officer at the jurisdiction where the incident
                    ...
                    <li>
                        4. Document confirming the loss or damage of the manager or owner of the lodging where the
                ...
                <p>
                    <strong>Credit Card Liability</strong>
                </p>
                <ul>
                    <li>1. Copy of daily report of the local police officer at the jurisdiction where the incident
                        occurred
                    </li>
                    <li>2. Document showing the list of unauthorized transactions using the credit card
                    </li>
                </ul>
                ...
                <p>
                    <strong>Complaints Management Section
                    </strong><br>
