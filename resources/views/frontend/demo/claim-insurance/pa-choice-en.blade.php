...
@section('page')
    ...
    <main>
        <article class="wrapper">
            ...
            <div>
                <h2 class="text-primary">Claims Handling Process for Personal Accident PA Choice</h2>
                <h2 class="text-primary">1. Process, Period, and Method of Claims Submission </h2>
                <ul>
                    <li>
                        <strong>1.1. Claims Submission Channels
                        </strong>
                        <ul style="padding-left:20px;">
                            ...
                            <li>
                                - E-mail Contact: <a href="mailto:Tunepa.claim@tuneprotect.com"
                ...
                <ul>
                    <li>1. Claims form <a href="/storage/claim-insurance/pa-choice/death.pdf"
                                          ...
                                          title="(click here to download)"><strong>(click here to download)</strong></a> which
                        shall be completed fully and correctly
                    </li>
                    ...
                    <li>5. Copy of death certificate signed for certification of true copy by the beneficiary
                    </li>
                    ...
                    <li>13. Copy of house registration of the beneficiary signed for certification of the true copy</li>
                    ...
                    <li>16. Copy of the first page of saving account passbook of the beneficiary</li>
                </ul>
                <p>
                    <strong> In case of dismemberment and loss of sight, please submit the following supporting
                        documents for the claims consideration <span
                ...
                <ul>
                    ...
                    <li>10. Summary of the case and photo of the scene <span style="text-decoration: underline;">(if any)</span>
                        signed for certification of true copy by
                        the competent police officer

                    </li>
                    <li>11. Copy of the first page of saving account passbook of the insured</li>
                </ul>
                ...
                <ul>
                    <li>1. Claims form
                        <a href="/storage/claim-insurance/pa-choice/permanent-disability.pdf"
                           style="color:rgb(0, 0, 238);"
                           title="(click here to download)"><strong>(click here to download)</strong></a> which shall be
                    ...
                    <li>5. Copy of disabled person identification card</li>
                    <li>6. Form of diagnosis and assessment of permanent disability issued by the physician</li>
                    <li>7. Copy of all medical history from the hospital, ranging from the occurrence of the incident to
                        the present
                    </li>
                    <li>8. Recent full-body photo of the insured showing the present condition
                    </li>
                    <li>9. Daily report on the incident <span style="text-decoration: underline;">(if any)</span>
                        (signed for certification of true copy by the competent police officer)
                    </li>
                    ...
                    <li>14. Certificate or letter of appointment of the curator/guardian</li>
                    <li>15. Copy of the first page of saving account passbook of the insured/the curator</li>
                </ul>
                <p>
                    <strong>In case of Medical Expense per Occurrence, please submit the following supporting documents
                ...
                <ul>
                    ...
                    <li>2. Medical certificate
                    </li>
                    <li>3. Receipt of medical expense with details (original)
                    </li>
                    <li>4. Expense summary/List of expense summary/Statement cover (in case IPD)
                    </li>
                    ...
                    <li>8. Copy of identification card of the insured signed for certification of true copy</li>
                    <li>9. Copy of the first page of saving account passbook of the insured
                    </li>
                </ul>
                <p>
                    <strong> In case of Hospital Cash income benefit arising from General accident, please submit the
                        following supporting documents for the claims consideration
                        <span style="text-decoration: underline;">(original)</span></strong>
                </p>
                ...
                <p>
                    <strong>In case of Funeral arising from accident and/or sickness, please submit the following
                        supporting documents for the claims consideration
                        <span style="text-decoration: underline;">(original)</span></strong>
                </p>
                <ul>
                    <li>1. Claims form <a href="/storage/claim-insurance/pa-choice/death.pdf"
                    ...
                    <li>10. Forensic autopsy (if any)</li>
                    <li>11. Copy of all medical history from the hospital, ranging from the occurrence of the incident
                        to the time of death
                    </li>
                    <li>12. Copy of identification card of the beneficiary signed for certification of the true copy
                ...
                <p>
                    <strong>Complaints Management Section </strong><br>
