...
<head>
    ...
    <title>Set up a new password for {{$app_name}}</title>
    <!--
                            ...
                            <tr>
                                <td class="content-cell">
                                    ...
                                    <p>You recently requested to reset your password for your {{$app_name}} account.
                                        Use the button below to reset it. <strong>This password reset is only valid for
                                            the next 24 hours.</strong></p>
                                    <!-- Action -->
                                    ...
                                    <p>For security, this request was received from
                                        a <?php echo $_SERVER['HTTP_USER_AGENT'] ?>. If you did not request a password
                        ...
                        <table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0">
                            <tr>
                                <td class="content-cell" align="center">
                                    <p class="sub align-center">&copy; {{date('Y')}} {{$app_name}}. All rights
                                        reserved.</p>
                                </td>
                            </tr>
                        </table>
