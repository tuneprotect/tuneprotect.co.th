...
return [
    "CI" => [
        "sum_insured_8" => "<h6>บริการฟรี</h6>
<span>พิเศษ ค่าบริการแพทย์ทางไกล 1 ครั้งต่อปี</span>",
        "sum_insured_1" => "<h6> ข้อตกลงคุ้มครองการป่วยเฉพาะโรคร้ายแรงระดับเริ่มต้นถึงระดับปานกลาง
กรณีที่เจ็บป่วยด้วยโรคใดโรคหนึ่งที่ระบุไว้ดังนี้</h6>
...
<span data-disease='t'>&bull; แผลไหม้ชนิดรุนแรงน้อย (Less severe burns / Second degree burn)</span>",
        "sum_insured_2" => "<h6> ข้อตกลงคุ้มครองการป่วยเฉพาะโรคร้ายแรงระดับรุนแรง
กรณีเจ็บป่วยด้วยโรคใดโรคหนึ่งที่ระบุไว้ดังนี้</h6>
...
<span data-disease='t'>&bull; การบาดเจ็บที่ศีรษะอย่างรุนแรง (Major Head Trauma)</span>",
        "sum_insured_3" => "<span data-disease='d'><h6> ข้อตกลงคุ้มครองการป่วยเฉพาะโรคเบาหวานกรณีเจ็บป่วยด้วยโรคใดโรคหนึ่งที่ระบุไว้ดังนี้</h6>
...
//        "sum_insured_8" => "<div class='expand'><h6>บริการฟรี <i class='icofont-caret-up action-expand-col'></i></h6>
//<div style='display: none' class='package-number-ci'>การวินิจฉัยครั้งที่สอง</div></div>",
        "sum_insured_4" => "<h6>  ผลประโยชน์การชดเชยรายได้รายวันจากการเข้ารักษาตัวเป็นผู้ป่วยในอันเนื่องมาจากโรคร้ายแรง</h6>
ค่าทดแทนสำหรับเงินชดเชยรายได้รายวัน สูงสุดไม่เกิน 15 วันต่อปีกรมธรรม์",
        "sum_insured_5" => "<h6> ผลประโยชน์ค่าจ้างพยาบาลพิเศษอันเนื่องมาจากโรคร้ายแรง</h6>
ค่าทดแทนสำหรับค่าจ้างการบริการพยาบาลพิเศษรายวัน  สูงสุดไม่เกิน 15 วันต่อปีกรมธรรม์",
        "sum_insured_6" => "<h6> ข้อตกลงคุ้มครองผลประโยชน์การเสียชีวิต การสูญเสียอวัยวะ สายตา หรือทุพพลภาพถาวรสิ้นเชิง </h6>
(จำกัดความรับผิดการถูกฆาตกรรมหรือถูกทำร้ายร่างกาย 50% ของจำนวนเงินเอาประกันภัย)",
        "sum_insured_7" => "<h6> ผลประโยชน์ค่าจ้างพยาบาลพิเศษอันเนื่องมาจากโรคร้ายแรง</h6>
ค่าทดแทนสำหรับค่าจ้างการบริการพยาบาลพิเศษรายวัน",
        "sum_insured_9" => "<h6>บริการฟรี</h6>
<span>การวินิจฉัยครั้งที่สอง</span>",
    ]
];
